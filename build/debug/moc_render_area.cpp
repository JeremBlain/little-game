...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_render_area_t, stringdata) + ofs \
...
const QMetaObject render_area::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_render_area.data,
      qt_meta_data_render_area,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_render_area.stringdata))
